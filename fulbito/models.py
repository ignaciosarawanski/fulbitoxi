...
class League(models.Model):
    ...
    founding = models.IntegerField(blank=True, null=True)
...
class Player(models.Model):
    ...
    main_position = models.CharField(max_length=3, blank=True, null=True)
    alt_position1 = models.CharField(max_length=3, blank=True, null=True)
    alt_position2 = models.CharField(max_length=3, blank=True, null=True)
    citizenship = models.CharField(max_length=50, blank=True, null=True)
    foot = models.CharField(max_length=12, blank=True, null=True)
